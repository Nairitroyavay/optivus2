...
abstract final class EventNames {
  ...
  static const routineWindowMissed = 'routine_window_missed';
  ...
  static const all = <String>{
    ...
    streakPaused,
    streakResumed,
    routineBlockCompleted,
    routineDaySummarized,
    routineWindowMissed,
    routineTemplateCreated,
    routineTemplateUpdated,
    routineTemplateDeleted,
    coachMessageSent,
    coachReplied,
    coachReEnabled,
    weeklyInsightReady,
    ...
    fitnessActivityPaused,
    fitnessActivityResumed,
    fitnessActivityCompleted,
    runningActivityCompleted,
    walkingActivityCompleted,
    cyclingActivityCompleted,
    hikingActivityCompleted,
    swimmingActivityCompleted,
    gymActivityCompleted,
    fitnessActivityCancelled,
    fitnessActivityDiscarded,
    routeTrackingStarted,
    routeTrackingStopped,
    routeSaved,
    routeReviewOpened,
    fitnessGoalCreated,
    fitnessGoalProgressUpdated,
    fitnessGoalCompleted,
    weeklyDistanceGoalCompleted,
    fitnessStreakUpdated,
