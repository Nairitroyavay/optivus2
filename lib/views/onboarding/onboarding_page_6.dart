  ...
  Widget _buildCustomCard() {
    return LiquidCategoryCard(
      ...
      customDroplets: [
        ...
        _drop(-1, 10, 9, const Color(0xFFCBD5E1).withValues(alpha: 0.50),
            right: 16),
                                ...
                                switch (index) {
                                  ...
                                  case 0:
                                    return LiquidCategoryCard(
                                      ...
                                      isSelected:
                                          _selectedCoach == 'Supportive',
                                      onTap: () => _selectCoach('Supportive'),
                                      customDroplets: [
                                        _drop(
                                            8, -1, 14, const Color(0xFF3B82F6),
                                            glo: true, bottom: 68),
                                        _drop(
                                            24, -1, 9, const Color(0xFF60A5FA),
                                            bottom: 76),
                                        _drop(
                                            5,
                                            -1,
                                  ...
                                  case 3:
                                    return LiquidCategoryCard(
                                      ...
                                      isSelected:
                                          _selectedCoach == 'Zen Master',
                                      onTap: () => _selectCoach('Zen Master'),
                                      customDroplets: [
                                        _drop(
                                            8, 12, 16, const Color(0xFF8B5CF6),
                                            glo: true),
                                        _drop(
                                            26, 8, 10, const Color(0xFFA78BFA),
                                            glo: true),
                                        _drop(
                                            4,
                                            28,
                                  ...
                                  case 4:
                                    return LiquidCategoryCard(
                                      ...
                                      isSelected:
                                          _selectedCoach == 'Motivational',
                                      onTap: () => _selectCoach('Motivational'),
                                      customDroplets: [
                                        _drop(
                                            -1, 8, 14, const Color(0xFFF43F5E),
                                            glo: true, right: 12),
                                        _drop(
                                            -1,
                                            20,
                                  ...
                                  case 5:
                                    return LiquidCategoryCard(
                                      ...
                                      customDroplets: [
                                        _drop(
                                            10, 8, 14, const Color(0xFFF59E0B),
                                            glo: true),
                                        _drop(
                                            26, 14, 8, const Color(0xFFFBBF24),
                                            glo: true),
                                        _drop(
                                            8,
                                            24,
