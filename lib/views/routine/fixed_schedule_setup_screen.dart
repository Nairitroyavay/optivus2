...
class SetupBlockItem {
  ...
  FixedBlock toFixedBlock() {
    ...
    String colorHex =
        '#${(color ?? Colors.blue).toARGB32().toRadixString(16).substring(2).toUpperCase()}';
...
class _FixedScheduleSetupScreenState
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) {
      ...
      setState(() {
        if (state.fixedBlocks.isNotEmpty) {
          items = state.fixedBlocks
              .map((b) => SetupBlockItem.fromFixedBlock(b))
              .toList();
        } else {
          items = [
            SetupBlockItem(
                id: 'add_morning', title: '', start: 7.5, isAdd: true),
            SetupBlockItem(
                id: 'add_midday', title: '', start: 12.5, isAdd: true),
            SetupBlockItem(
  ...
  void _saveToProvider() {
    ...
    final blocks =
        items.where((i) => !i.isAdd).map((i) => i.toFixedBlock()).toList();
        ...
        builder: (ctx) {
          return StatefulBuilder(builder: (context, setDialogState) {
            ...
            return AlertDialog(
                ...
                title: Text(item.isAdd ? 'Add New Block' : 'Edit Block Details',
                          ...
                          child: BackdropFilter(
                            ...
                            child: SingleChildScrollView(
                              ...
                              padding: EdgeInsets.only(
                                  top: 24, bottom: bottomPadding + 80),
                              child: SizedBox(
